...
def start_api_server():
    ...
    # Use the current directory DVF file
    os.environ["DVF_FILE_PATH"] = "dvf.csv"
...
if __name__ == "__main__":
    # Verify dvf.csv exists
    if not os.path.exists("dvf.csv"):
        print("ERROR: dvf.csv file not found! Please place the file in the current directory.")
        sys.exit(1)
